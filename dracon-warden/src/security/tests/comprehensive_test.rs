...
const CORPUS: &[SecretExample] = &[
    SecretExample {
        ...
        raw: "sk_live_51ABCDEF1234567890abcdef1234567890abcdef123",
    },
    SecretExample {
        name: "GitHub Token",
    ...
    SecretExample {
        name: "Slack Token",
        pattern: "Slack Token",
        raw: "xoxb-123456789012-1234567890123-AbCdEfGhIjKlMnOpQrStUvWx",
    },
    SecretExample {
    ...
    SecretExample {
        name: "GCP API Key",
        pattern: "GCP API Key",
        raw: "AIzaSyD-1234567890abcdef1234567890abcde",
    },
    SecretExample {
        name: "GCP OAuth Access Token",
        pattern: "GCP OAuth Access Token",
        raw: "ya29.a0AfH6SMC_1234567890abcdef1234567890abcdef1234567890",
    },
    SecretExample {
    ...
    SecretExample {
        ...
        raw: "ocid1.user.oc1.test.abcdef1234567890abcdef1234567890abcdef1234",
    },
    // SaaS
    SecretExample {
        name: "Stripe Live Secret Key",
        pattern: "Stripe Live Secret Key",
        raw: "sk_live_abcdefghijklmnopqrstuvwx123456",
    },
    SecretExample {
        name: "Stripe Test Secret Key",
        pattern: "Stripe Test Secret Key",
        raw: "sk_test_abcdefghijklmnopqrstuvwx123456",
    },
    SecretExample {
        name: "Slack Token",
        pattern: "Slack Token",
        raw: "xoxb-123456789012-123456789012-abcdef123456",
    },
    SecretExample {
        name: "Slack Webhook",
        pattern: "Slack Webhook",
        raw: "https://hooks.slack.com/services/T01234567/B01234567/abcdef1234567890abcdef12",
    },
    SecretExample {
        name: "Discord Token",
    ...
    SecretExample {
        ...
        raw: "SK1234567890abcdef1234567890abcdef",
    },
    SecretExample {
        name: "Twilio Account SID",
        pattern: "Twilio Account SID",
        raw: "AC1234567890abcdef1234567890abcdef",
    },
    SecretExample {
        name: "SendGrid API Key",
        pattern: "SendGrid API Key",
        raw: "SG.abcdefghijklmnopqrstuv.abcdefghijklmnopqrstuvwxyz1234567890abcdefg",
    },
    SecretExample {
        name: "Mailgun API Key",
        pattern: "Mailgun API Key",
        raw: "key-1234567890abcdef1234567890abcdef",
    },
    // Database & Generic
    SecretExample {
        name: "PostgreSQL URL",
...
fn test_auto_key_generation() -> Result<()> {
    ...
    let keys_dir = temp_repo.path().join(".demon").join("data").join("keys");
