...
Thank you for your interest in contributing! This project is designed for deterministic local automation, with human and AI-assisted contributions both welcome.
...
1. **Update README.md or crate docs** if the change affects user-visible workflows
...
6. Document in README.md or crate docs

## Commit Messages

Since this repo uses dracon-sync for auto-commit, you don't need to worry about commit messages if sync is running. The daemon generates deterministic commit messages directly from diffs.
...
- Check [README.md](README.md) and [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) for architecture details
