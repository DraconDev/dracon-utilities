...
1. **Task state transitions** (from ANY file — markdown, code comments, text)
   - `[x]` → `CLOSED: task name`
   - `[~]` → `WIP: task name`
   - Works in: `- [x]`, `* [x]`, `// [x]`, `# [x]`, `<!-- [x]`
