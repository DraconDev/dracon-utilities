# Dracon Commercial License v2.0

**Proprietary Use License — Effective 2026-05-16**
...
- **"Production Use"** means any use of Dracon Software in a live, revenue-generating, or publicly accessible context, including but not limited to: serving end users, supporting internal business operations, or enabling a commercial service. Evaluation, development, and testing use that does not serve end users or generate revenue is not Production Use.

- **"Competing Product"** means any software product or service that (a) provides substantially similar functionality to the Dracon Software, (b) is developed, sold, or marketed by an organization that competes directly with Dracon's commercial offerings, and (c) either (i) uses Dracon Software as a core component, or (ii) is offered as a substitute for Dracon Software in the same market segment.

- **"Licensed Instance"** means a single deployed instance of Dracon Software under this license. Each physical server, virtual machine, container, or distinct runtime environment counts as one Licensed Instance. Development and staging environments for the same production deployment do not require additional licenses.
...
Subject to the terms and payment obligations in this agreement, Licensor grants You a non-exclusive, non-transferable, limited license to:

1. **Use** Dracon Software in Your organization's internal development and production environments
2. **Modify** Dracon Software for Your own internal purposes
3. **Deploy** modified or unmodified versions of Dracon Software within Your Organization
4. **Sublicense** to wholly-owned subsidiaries within Your corporate group, provided the sublicensee is bound by equivalent restrictions

### What This License Does NOT Grant

- **No** right to sublicense Dracon Software to third parties (except as above)
- **No** ownership of Dracon's code, trademarks, patents, or other intellectual property
- **No** right to use Dracon Software in a Competing Product
- **No** right to distribute Dracon Software outside Your Organization
...
- Running Dracon Software to support commercial operations (e.g., internal tooling that generates revenue)
- Integrating Dracon Software into a product or service offered for sale or subscription

**Production Use does NOT include:**
...
If Your organization develops software that competes with Dracon's commercial offerings, You are not eligible for a Commercial License. You may instead use Dracon Software under AGPLv3 in compliance with its terms, or negotiate a separate agreement with Dracon.

Dracon reserves the right to verify compliance with this restriction and to terminate this license immediately upon discovering a violation.
...
It will renew automatically unless either party provides written notice of cancellation at least thirty (30) days before the renewal date.
...
Licensor does not warrant that Dracon Software will meet Your requirements, that it will be error-free, or that it will operate without interruption.
...
- Your use of Dracon Software in violation of this agreement
- Your violation of any third-party rights
- Your production application of Dracon Software (including any claims by end users or customers)
...
Any dispute arising out of or relating to this agreement shall be subject to the exclusive jurisdiction of the courts of England and Wales. Both parties consent to the jurisdiction of those courts for any legal proceedings.

If a dispute arises, the parties will attempt to resolve it through good-faith negotiation for thirty (30) days before either party may initiate court proceedings.
...
- Internal/non-commercial use by organizations without a Commercial License
- Academic and educational institutions
- Evaluation purposes (up to 90 days)
...
- **Assignment**: You may not assign this agreement or any rights under it without Licensor's prior written consent. Licensor may assign this agreement to a successor in interest in connection with a merger, acquisition, or sale of substantially all of its assets.

- **Force Majeure**: Licensor is not liable for any failure or delay due to causes beyond its reasonable control.
...
If You already have a signed agreement with Dracon, Your existing terms apply. Contact **license@dracon.uk** to confirm.
