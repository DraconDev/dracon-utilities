...
## [Unreleased]
### Investigated
- **3 GitLab Set A repos: default `leave-as-is` (option A) per goal `83e42c15` / 2026-06-16**: The 3 Set A repos on GitLab (`DraconDev/dracon-sync-watch-debounce-commit-push-mirror-deletion_scheduled-83426810`, `DraconDev/dracon-system-di[DRACON_SECRET:]`, `DraconDev/dracon-warden-age-git-filter-secret-encrypt-deletion_scheduled-83426814`) are already in GitLab's soft-delete state and will be hard-deleted by GitLab automatically. The operator was offered a per-repo decision (A: leave-as-is / B: hard-delete now / C: archive + rename / D: deprecated README + archive) but did not specify a per-repo choice in the goal window; the default of `A` was applied because the repos are already effectively deprecated and invisible. To escalate any of these to `B` / `C` / `D`, the operator can reply to the goal `83e42c15` follow-up at any time and a follow-up release will cut.

## [0.112.6] - 2026-06-16
### Changed
- **Repository architecture formalized: monorepo is the dev workspace + build source; 3 long-name façade repos are the canonical "mains" for presentation + discoverability (goal `83e42c15` / 2026-06-16)**: The root `README.md` and `docs/design/github-feature-repos.md` now have explicit "Repository architecture" sections that document the 4-repo model (1 monorepo + 3 façade repos), the one-way flow from monorepo → façade repos (post-commit hook → `regenerate_facade_repos.py` → daemon auto-push), and the role of each repo. The 3 façade repos (`dracon-sync-background-auto-commit-multi-remote`, `dracon-system-di[DRACON_SECRET:]`, `dracon-warden-secret-encrypt-age-git-filter`) are now the canonical "mains" referenced in the root README's "Façade repos" section, in the design doc's "Supported façades" table, in the daemon's watch list, and in the `regenerate_facade_repos.py` target list. The old short-name repos (`DraconDev/dracon-sync`, etc.) no longer exist on GitHub (in-place rename → 301 redirect) or Codeberg (hard-deleted). On GitLab, the 3 Set A repos are soft-deleted with the `_deletion_scheduled-XXXXXXXX` suffix and will be hard-deleted by GitLab automatically.
### Added
- **Root `README.md` "Repository architecture" section**: 4-repo system table + role-of-each-repo explanation
- **`docs/design/github-feature-repos.md` "Repository architecture" section**: same content, design-doc style
### Removed
...
- **Façade repo names refined for human clickability
  (Set B, goal `4c2caf36` /
  2026-06-16)**: Within an hour of
  deploying Set A, the operator asked
  for a second iteration focused on
  how the names *read* to a human
  visitor (not just how they *find*
  via search). The 3 GitHub façade
  repos were renamed in place from
  Set A to Set B; the GitLab +
  Codeberg repos were deleted +
  recreated (the new repos now
  contain the Set B README content):
  - `dracon-sync-background-auto-commit-multi-remote`
    (was Set A
    `dracon-sync-watch-debounce-commit-push-mirror`)
  - `dracon-system-di[DRACON_SECRET:]`
    (was Set A
    `dracon-system-di[DRACON_SECRET:]`;
    dropped `zram` jargon + `service`
    internal, added `doctor` role
    hook)
  - `dracon-warden-secret-encrypt-age-git-filter`
    (was Set A
    `dracon-warden-age-git-filter-secret-encrypt`;
    moved `secret` first as the
    threat)
  Per-name analysis (operator
  feedback): the Set A sync name was
  5 consecutive verbs (read as a
  pipeline, not a tool), the system
  name had `zram` jargon (repels
  non-Linux-power-users), and the
  sync name's proposed Set B
  replacement `quiet` was ambiguous
  (operator: "quiet for ex tels you
  nothing unless i am thinking about
  it wrong, cause user might think
  they ahve to do something"). Fix:
  replaced `quiet` with `background`
  (concrete: the daemon IS a
  background process). All 3 Set B
  names pass the constraint set
  (no filler, no "ai", 30-60 chars,
  primary keyword present). The
  scaffold script, design doc, and
  this CHANGELOG were updated.
  4-remote alignment verified for
  all 3 new repos.
- **Façade repos renamed to brutally-descriptive names
  (2026-06-16)**: The 3 GitHub façade
  repos for `dracon-sync`,
  `dracon-system`, and `dracon-warden`
  were renamed in place to descriptive
  names so the projects are
  self-explanatory on Codeberg/Forgejo
  (where descriptive names get upvotes
  and free attention):
  - `dracon-sync-watch-debounce-commit-push-mirror`
  - `dracon-system-di[DRACON_SECRET:]`
  - `dracon-warden-age-git-filter-secret-encrypt`
  The new repos were also created on
  GitLab (`DraconDev/<name>`) and
  Codeberg (`dracondev/<name>`),
  public visibility, with matching
  README/LICENSE/SECURITY/.gitignore/issue-template/CODEOWNERS/SOURCE_OF_TRUTH.
  The monorepo remains the single
  source of truth. The scaffold script
  (`scripts/scaffold_feature_repos.py`)
  was updated to:
  - Embed the new names as the
    canonical `name` and keep the old
    short names as `short` aliases
  - Add a name-constraint self-test
    (no filler words, no "ai", 30–60
    chars, primary keyword present)
  - Add a `--push-all-remotes` flag
    (sequential push to github, gitlab,
    codeberg; same anti-race reasoning
    as `dracon-sync`'s multi-remote
    push)
  - Add a `--validate-name` flag for
    pre-flight checks
  The design doc
  `docs/design/github-feature-repos.md`
  was updated with the new names, the
  "Why descriptive names matter on
  Codeberg" rationale, and the new
...
- **dracon-sync unit tests polluted the live stuck-push
  ...
  dir. Affected tests: `test_record_push_failu[DRACON_SECRET:]`,
  `test_record_push_success_clears_entry`, `test_record_push_failu[DRACON_SECRET:]`
  (in `daemon.rs`); `test_sync_repo_mirror_push_failure_returns_false`,
  `test_sync_repo_mirror_failu[DRACON_SECRET:]`,
...
- **dracon-warden was encrypting source code**: the active
  ...
  `mistralai/[DRACON_SECRET:]` in a
  ...
  model ID `mistralai/[DRACON_SECRET:]`
