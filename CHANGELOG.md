...
- **dracon-sync**: Strengthened mass-deletion guard — blocks at ≥85% deletion (graduated threshold)
  - 100% wipe still triggers full incident logging
  - Partial deletions below 85% are allowed through normally
