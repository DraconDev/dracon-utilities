...
- **dracon-sync: `check-untracked-md` subcommand
  (goal `e680cfa9` / 2026-06-16)**: defensive guard
  for the CWD-drift class of bug. Walks watched repos
  (or a single repo with `--repo`) and reports any
  untracked `.md`/`.txt` files that are NOT
  gitignored. The daemon's commit-all policy
  intentionally does NOT auto-stage untracked
  content, so this command gives the operator
  visibility into the specific subset of untracked
  files that are most likely deliverables (docs,
  research, notes, design). Includes `--json` mode
  for tooling.
- **dracon-sync: `noteworthy_untracked()` function
  in `git::diff` (goal `e680cfa9` / 2026-06-16)**:
  cheap (~50ms per repo) helper that runs
  `git ls-files --others --exclude-standard -z`
  and filters to `.md`/`.txt` extensions, returning
  paths relative to the repo root sorted. Honors
  `.gitignore` re-include rules like `!*.md`.
- **dracon-sync: 6 unit tests for
  `noteworthy_untracked` (goal `e680cfa9`)**:
  empty repo, finds `.md`, finds `.txt`, ignores
  gitignored, excludes other extensions, finds
  the doubled-path bug class.
...
- **dracon-sync unit tests polluted the live stuck-push
  ...
  dir. Affected tests: `test_record_push_failu[DRACON_SECRET:]`,
  `test_record_push_success_clears_entry`, `test_record_push_failu[DRACON_SECRET:]`
  (in `daemon.rs`); `test_sync_repo_mirror_push_failure_returns_false`,
  `test_sync_repo_mirror_failu[DRACON_SECRET:]`,
...
- **dracon-warden was encrypting source code**: the active
  ...
  `mistralai/[DRACON_SECRET:]` in a
  ...
  model ID `mistralai/[DRACON_SECRET:]`
