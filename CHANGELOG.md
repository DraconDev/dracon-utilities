...
- **LOW-hygiene clippy `--all-targets` cleanup** (2026-07-28, goal
  `20260728001443-t1ckfc`): closes the 17 pre-existing test-code
  clippy lints accumulated across the v0.112.20→v0.113.4 line. All
  17 instances were FIXED inline in the v0.113.5 MEDIUM-finding
  remediation batch commits `572f151`..`c691555`; ZERO were
  allowed via `#[allow(clippy::...)]`. The 17 fixes split into 8
  lint categories: `int_plus_one` (1), `bool_assert_comparison` (2),
  `cmp_owned` (2), `useless_conversion` (1), `unused_variables` (3),
  `useless_vec` (3), `unnecessary_get_then_check` (2),
  `cloned_ref_to_slice_refs` (3). Per-lint summary with representative
  file:line refs lives at
