...
- **dracon-utilities: removed load-bearing symlink
  `~/Dev/dracon-libs` (drafted, awaiting operator
  approval)** (2026-06-15, goal `cca2169f`):
  `~/Dev/dracon-libs` was a symlink to
  `/tmp/lib-edit` and was invisible to the daemon
  (which doesn't follow symlinks). It was also
  load-bearing: the workspace had 6 `path =
  "../dracon-libs/..."` deps. Investigation
  found 4 of those deps were dead (no `.rs` file
  uses them) and 2 (`dracon-git`,
  `dracon-system-lib`) were identical to crates.io
  94.7.0. Proposed refactor: drop the 4 dead deps
  + drop the `path` for the 2 versioned ones, then
  `rm` the symlink. Documented in
...
- **dracon-sync unit tests polluted the live stuck-push
  ...
  dir. Affected tests: `test_record_push_failu[DRACON_SECRET:]`,
  `test_record_push_success_clears_entry`, `test_record_push_failu[DRACON_SECRET:]`
  (in `daemon.rs`); `test_sync_repo_mirror_push_failure_returns_false`,
  `test_sync_repo_mirror_failu[DRACON_SECRET:]`,
...
- **dracon-warden was encrypting source code**: the active
  ...
  `mistralai/[DRACON_SECRET:]` in a
  ...
  model ID `mistralai/[DRACON_SECRET:]`
