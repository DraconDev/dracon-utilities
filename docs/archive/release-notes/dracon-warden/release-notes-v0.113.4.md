# dracon-warden v0.113.4 (2026-08-09)

Git filter encryption and repository hardening for secrets at rest.

## What's Changed

- Bump version to 0.113.4
- (See CHANGELOG.md for the full list of changes in this release)

## Install

```bash
cargo install dracon-warden --version 0.113.4
```
...
**Full Changelog**: https://github.com/DraconDev/dracon-warden-secret-encrypt-age-git-filter/compare/0.113.3...v0.113.4
