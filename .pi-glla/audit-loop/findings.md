...
- [x] DECIDED [D7] (2026-09-09 — operator approved "redact all userinfo"): redact_origin_credentials now strips the ENTIRE userinfo (https://host/...) — choice made: redact ALL userinfo incl. bare usernames (cost: loses username context in logs) over keep verbatim (cost: token-as-username PATs leak into terminal/JSON reports) (dracon-sync/src/ownership.rs:462)
